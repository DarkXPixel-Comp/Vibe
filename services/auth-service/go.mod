...
require (
	buf.build/gen/go/darkxpixel/vibe-contracts/grpc/go v1.5.1-20251005140752-a13cb85e6ff5.2
	buf.build/gen/go/darkxpixel/vibe-contracts/protocolbuffers/go v1.36.1-20251005140752-a13cb85e6ff5.1
